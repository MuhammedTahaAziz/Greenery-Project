...
export default function AutumnFlower() {
    ...
    const autumnFlowers = posts.filter(
        (post) =>
            post.category_name === "flower" && post.filter_name === "autumn"
    );
        ...
        <div className="">
            ...
            >
                <table className="w-full h-auto">
                    ...
                    {!load && autumnFlowers.length
                        ? autumnFlowers.map((post) => (
