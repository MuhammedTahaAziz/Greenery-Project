...
export default function SpringFlower() {
    ...
    const springFlowers = posts.filter(
        (post) =>
            post.category_name === "flower" && post.filter_name === "spring"
    );
        ...
        <div className="">
            ...
            >
                <table className="w-full h-auto">
                    ...
                    {!load && springFlowers.length
                        ? springFlowers.map((post) => (
