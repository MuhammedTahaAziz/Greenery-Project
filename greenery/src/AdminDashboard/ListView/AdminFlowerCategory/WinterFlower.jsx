...
export default function WinterFlower() {
    ...
    const winterFlowers = posts.filter(
        (post) =>
            post.category_name === "flower" && post.filter_name === "winter"
    );
        ...
        <div className="">
            ...
            >
                <table className="w-full h-auto">
                    ...
                    {!load && winterFlowers.length
                        ? winterFlowers.map((post) => (
