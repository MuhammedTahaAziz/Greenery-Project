...
export default function WinterTree() {
    ...
    const winterTrees = posts.filter(
        (post) => post.category_name === "tree" && post.filter_name === "winter"
    );
        ...
        <div className="">
            ...
            >
                <table className="w-full h-auto">
                    ...
                    {!load && winterTrees.length
                        ? winterTrees.map((post) => (
