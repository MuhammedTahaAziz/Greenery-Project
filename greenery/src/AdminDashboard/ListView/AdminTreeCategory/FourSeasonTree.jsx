...
export default function FourSeasonTree() {
    ...
    const fourSeasonTrees = posts.filter(
        (post) =>
            post.category_name === "tree" && post.filter_name === "fourseasons"
    );
        ...
        <div className="">
            ...
            >
                <table className="w-full h-auto">
                    ...
                    {!load && fourSeasonTrees.length
                        ? fourSeasonTrees.map((post) => (
