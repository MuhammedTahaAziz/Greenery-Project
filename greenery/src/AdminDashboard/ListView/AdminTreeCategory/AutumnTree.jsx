...
export default function AutumnTree() {
    ...
    const autumnTrees = posts.filter(
        (post) => post.category_name === "tree" && post.filter_name === "autumn"
    );
        ...
        <div className="">
            ...
            >
                <table className="w-full h-auto">
                    ...
                    {!load && autumnTrees.length
                        ? autumnTrees.map((post) => (
